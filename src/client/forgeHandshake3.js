...
// modules since HF35 (loginBytes.js, owoHandshake.js) — one implementation
// for this lane and the Fabric lib's login gates (injected by the app).
const { readVarInt, writeVarInt, readString, writeString } = require('./loginBytes')
const { modsPathsFor, RAW_LOGIN_PROTOCOLS } = require('./owoHandshake')
